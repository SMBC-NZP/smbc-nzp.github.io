...
<p>Before we begin, you will have install two packages onto your computer.</p>
<ul>
<li><b>RCurl</b>: Allows you to read and execute files and code located online</li>
<li><b>tidyverse</b>: A suite of packages designed to streamline the coding process.<i>We will use tidyverse extensively during this course!</i></li>
</ul>

<p><i class= "fa fa-user-circle-o" style = "font-size: 150%;"> The following code installs the necessary packages. Open R Studio. Copy-and-paste (CTRL+C, CTRL+V) the following code into your <b>source pane</b>. Execute the code by selecting the section with your mouse and using the keyboard shortcut CTRL+Enter.</p>
...
<br>
<p><i class= "fa fa-user-circle-o" style = "font-size: 150%;"> The following code loads the packages into R. Execute the code below in R.</p>
```{r, eval = FALSE}
library(tidyverse)
...
<p>For this lesson, we will use two example data frames: Bird traits collected by Wilman et al. (2014), and bird point count observations from Washington, DC (Evans et al. 2018).</p>
