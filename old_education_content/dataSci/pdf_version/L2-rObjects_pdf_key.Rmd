...
```{r printAvec, echo= TRUE, results = 'hide'}
...
```{r classType_avec, echo= TRUE, results = 'hide'}
...
```{r length_avec, echo= TRUE, results = 'hide'}
...
```{r str_avec, echo= TRUE, results = 'hide'}
...
```{r summary_avec, echo= TRUE, results = 'hide'}
# str can be used to observe object structure:
...
```{r heteroV, echo= TRUE, results = 'hide'}
...
```{r heteroV_class, echo= TRUE, results = 'hide'}
# All values in a vector must be of the same class:
...
```{r heteroV_str, echo= TRUE, results = 'hide'}
# All values in a vector must be of the same class:
...
```{r heteroV_summary, echo= TRUE, results = 'hide'}
# All values in a vector must be of the same class:
...
```{r vectorNames, echo= TRUE, results = 'hide'}
...
```{r numeric3, echo= TRUE, results = 'hide'}
...
```{r numeric123, echo= TRUE, results = 'hide'}
...
```{r vectorNames_subset, echo= TRUE, results = 'hide'}
...
```{r vectorNames_subset2, echo= TRUE, results = 'hide'}
# Indexing a vector by the name of the value:
...
```{r mat_ncol, echo= TRUE, results = 'hide'}
# Convert c(1, 1, 2, 3) to a matrix:
...
```{r mat_byrow, echo= TRUE, results = 'hide'}
# Convert c(1, 1, 2, 3) to a matrix:
...
```{r mat_hetero, echo= TRUE, results = 'hide'}
...
```{r mat_hetero_class, echo= TRUE, results = 'hide'}
...
```{r mat_hetero_typeof, echo= TRUE, results = 'hide'}
...
```{r myMat, echo= TRUE, results = 'hide'}
...
```{r myMat_print, echo= TRUE, results = 'hide'}

myMatrix
```

<p>Determine the attributes of the object `myMatrix`:</p>
```{r myMat_attributes, echo= TRUE, results = 'hide'}
...
```{r myMat_colNames, echo= TRUE, results = 'hide'}
...
```{r myMat_index, echo= TRUE, results = 'hide'}
...
```{r myMat_index1, echo= TRUE, results = 'hide'}
...
```{r myMat_index3, echo= TRUE, results = 'hide'}

myMatrix[1:3, 2]
```

<li>The first <b>and</b> third values in column 2:</li>
```{r myMat_index4, echo= TRUE, results = 'hide'}
...
```{r list_homoG, echo= TRUE, results = 'hide'}
# Homogeneous list of values:

list(1, 1, 2)
```
<li>A heterogeneous list of values:</li>
```{r list_heteroG, echo= TRUE, results = 'hide'}
...
```{r list_multiD, echo= TRUE, results = 'hide'}
...
```{r list_assigned, echo= TRUE, results = 'hide'}
# Assigned list:
...
```{r list_class, echo= TRUE, results = 'hide'}
...
```{r list_length, echo= TRUE, results = 'hide'}
...
```{r list_str, echo= TRUE, results = 'hide'}
...
```{r list_names1, echo= TRUE, results = 'hide'}

list(apple = 1, pear = 2)
```

<li>Specify the names of objects in a pre-existing list:</li>
```{r list_names2, echo= TRUE, results = 'hide'}
myList_named <- 
  myList
...
```{r list_namesAttributes, echo= TRUE, results = 'hide'}
...
```{r list_metadata, echo= TRUE, results = 'hide'}
# Adding attributes to myMatrix:
...
```{r list_indexing, echo= TRUE, results = 'hide'}
# List indexing:
...
```{r list_indexing_name1, echo= TRUE, results = 'hide'}
...
```{r list_indexing_name2, echo= TRUE, results = 'hide'}
# Lists can be indexed by name using the notation:
...
```{r dFrame, echo= TRUE, results = 'hide'}
...
```{r dFrame_hetero, echo= TRUE, results = 'hide'}
...
<br>
<p>As described above, the vectors that make up a data frame must be of the same length. Before making data frames, make sure to explore their length -- making data frames of unequal length vectors may result in errors or lead to unexpected results.</p>
...
```{r dFrame_badLength1, echo= TRUE, results = 'hide'}
data.frame(
  1:2,
  1:4
  )
...
```{r dFrame_badLength2, echo= TRUE, results = 'hide'}
data.frame(
  1,
  1:4
  )
...
```{r dFrame_name1, echo= TRUE, results = 'hide'}
# Make a data frame from vectors:
...
```{r myDf_index1, echo= TRUE, results = 'hide'}
...
```{r myDf_index2, echo= TRUE, results = 'hide'}
...
```{r myDf_index3, echo= TRUE, results = 'hide'}
...
```{r myDf_index4, echo= TRUE, results = 'hide'}
...
```{r myDf_index5, echo= TRUE, results = 'hide'}
...
```{r myDf_index6, echo= TRUE, results = 'hide'}
...
```
<li>A tibble:</li>
```{r tibble, echo= TRUE, results = 'hide'}
tibble(
  words = c('hello', 'hello', 'world' , 'world'),
  integers = 1:4
)
...
```{r as_tibble, echo= TRUE, results = 'hide'}
