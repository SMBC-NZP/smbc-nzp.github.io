...
<br><br>
<li>The code below is an incomplete function that counts the number of values in a vector that contain a given letter, `x`, as its last letter. Complete this function and test by calculating the number of values in monthChar that end in the letter "y".
<br><br>
...
<li>Use the function you created in 4.d to subset birdCounts to just insectivore observations.</li>

<br><br>

<li>The code below is an incomplete function that is intended to allow users to subset a data frame to a given diet class (as 4.e above). Complete this function and use it to subset birdCounts to just insectivore observations.</li>
