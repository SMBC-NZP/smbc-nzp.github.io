...
<hr>
<p>In this lesson we will be exploring how to query data using what is often called "matrix notation". We will learn a <b>much easier</b> way to query data by the end of this workshop. I start by teaching this method of querying because it is helpful in understanding how R objects work, gives a glimpse of what is happening under the hood when using other querying techniques, and still used for some advanced querying techniques.</p>
...
<h2>Indexing and logic: Querying data frames</h2>
...
<h2>Indexing and logic: Working with strings</h2>
<br>
<br>
...
<h2>Indexing and logic: Summarizing and queries</h2>
...
<h2>Indexing and logic: Practice with real data</h2>
