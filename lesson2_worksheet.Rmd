...
<br>
<p>Querying data frames can be executed using the same notation as matrices:</p>
<br>

```{r df query with which, eval = FALSE}

# Logical test of whether the first column of df is greater than 1:
...
# Query df by index and logical statement:
