...
<p`exampleFactor`, as written, would produce the following output when plotted (<i>Note: plotting will be covered in a later lesson, your code will not produce a plot output</i>):</p>
