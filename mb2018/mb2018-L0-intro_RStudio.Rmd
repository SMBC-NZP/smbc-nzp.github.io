...
<ul>
<li>Files: A file manager window (the initial location should default to your working directory).</li>
...
<div class = "roundBorderBlack">
<br>
<p><i class="fa fa-user-secret" aria-hidden="true" style = "font-size: 150%"></i> Libraries should always be loaded in the  source panel! It's best to load libraries one of three locations:</p>
<ul>
