...
<p>Above, we worked with several functions (e.g., "c", "mean"). Functions are a special type of R object allow you to simplify complex tasks, which is especially useful if you need to run a task multiple times. Program R contains many functions and many more still are created by R users and provided to the R community as collections of functions known as packages (or libraries).</p>
<br>
<p>The basic structure functions is as follows (<b>DO NOT RUN</b>):</p>
```{r, eval=FALSE}
