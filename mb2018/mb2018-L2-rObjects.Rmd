...
## Tibbles!
<br>
<p>The final object that we will look at is an object class provided by the package "tidyverse". A <b>tibble</b> is a special type of data frame. You can make a tibble using the `data_frame()` function. The arguments for this function are the same as that of `data.frame()`.</p>
<br>
