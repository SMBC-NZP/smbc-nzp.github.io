...
<p>You can determine the attributes of an object using the function `attributes()`. Vectors typically do not have attributes. Some attributes, however, can be added to vectors. For example, we might want to add names to a vector. We can do so using the `names()` function.</p>
