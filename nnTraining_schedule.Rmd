...
<img style="float: right;
                        ...
                        border-color: white;" src="nnLogo.png" width="20%" />
<br>
...
<hr>
<p><b>Is there anything you should do to prepare yourself for the training?</b> Prior to attending the training, please thoroughly read the <a href = "https://github.com/bsevansunc/Nestwatch/raw/master/nn_protocolDocument.pdf">Neighborhood Nestwatch protocols. Additionally, on Tuesday at 2 pm we will host a paper discussion on some of the foundational papers of Neighborhood Nestwatch. The goal of this discussion is to provide you with an understanding of the science that you will be a part of. Please read at least the abstracts of the following papers by next Tuesday:</p>
<ul>
...
<img style="float: left;
  ...
  border-width: 10px;
  box-shadow: 0px 0px 0px 0px;
  border-color: white;" src="gitLogo.png" height = "70" />
 ...
 <img style="float: right;
                                 ...
                                 border-width: 10px;
                                 box-shadow: 0px 0px 0px 0px;
                                 border-color: white;" src="nzpLogoSideways2.png" height = "70" />
